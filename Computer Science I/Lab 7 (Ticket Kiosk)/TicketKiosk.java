...
public class TicketKiosk
{
    ...
    public void purchaseTickets(Scanner keyboard)
    {
        ...
        do
        {
            ...
            else
            {
                ...
                String customerSsn = keyboard.nextLine();
                ...
                {
                    Ticket ticket = new 
                        Ticket(customer, findFlight(flightNumber));
                    System.out.println("\n" + ticket.toString() + "\n");
                }
            }
        }
        while (!customerName.equalsIgnoreCase("exit"));
    }
    ...
    public Flight readOneFlight(Scanner inFile) throws IOException
    {
        ...
        Flight flight = new Flight(flightNumber, destination, pilot, date);

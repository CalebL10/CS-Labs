...
{
    /**
     * Tests for existance of the Bonus class.
     */
    @Test
    public void testBonusClassExists()
    {
        Class c;
        try
        {
            c = Class.forName("Bonus");
        }
        catch (Exception e)
        {
            fail("Bonus: unable to perform test. "
                 + "Did you name the class correctly?");
        }
    }

    /**
     * Tests the main method in Bonus.
     */
    @Test
    public void testBonusMain()
    {
